...
# Juicer launcher for the sequential LEMON image.
#
...
#
# The default image is `lemon-juicer_sequential.sif`. If it does not exist
# yet, the script falls back to `lemon-juicer-test.sif`. Override with:
#   LEMON_IMAGE=/path/to/image.sif ./run_juicer_sequential.bash
#
# Optional positional argument:
#   ./run_juicer_sequential.bash [OBJECT]
#
...
echo "Launching sequential Juicer for ${OBJECT}" >&2
